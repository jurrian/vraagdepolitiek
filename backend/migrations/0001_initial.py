# Generated by Django 2.1.1 on 2018-09-22 09:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.Answer')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='backend.Question')),
            ],
        ),
        migrations.CreateModel(
            name='Representative',
        ...
        migrations.AddField(
            model_name='question',
            name='answers',
            field=models.ManyToManyField(blank=True, through='backend.QuestionAnswer', to='backend.Answer'),
        ),
        migrations.AddField(
            model_name='question',
            name='themes',
